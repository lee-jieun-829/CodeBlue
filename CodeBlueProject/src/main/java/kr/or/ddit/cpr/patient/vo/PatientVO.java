package kr.or.ddit.cpr.patient.vo;
...
import kr.or.ddit.cpr.vo.RoomVO;
...
public class PatientVO {
	 ...
	 private ScreeningVO screeningVO; // 접수 정보
	 private String currentStatus; // 환자 최신 상태 값(selectPatientList 서브쿼리 결과 직접 받을 변수)
	 private String employeeName; // 담당의 이름 (입원 접수 시 필요)
	 private int chartNo; // 담당의 이름 (입원 접수 시 필요)
	 private OutPatientChartDrugVO outPatientChartDrugVO; //환자 투약 기록용
	 private RoomVO roomVO; //입원실
