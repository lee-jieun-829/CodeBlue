    ...
    <aside class="sidebar sidebar-vertical">
	    <nav class="gnb sidebar-nav">
	        ...
	        <div class="sidebar-nav-group">
	            <%-- <a href="${pageContext.request.contextPath }/management/dashboard" class="gnb-item sidebar-nav-item" id="gnb-dashboard">
	                <i class="sidebar-nav-icon icon icon-desktop"></i>
	                <span class="sidebar-nav-label">대시보드</span>
	            </a> --%>
	            
	            <a href="${pageContext.request.contextPath }/management/reception" class="gnb-item sidebar-nav-item" id="gnb-reception">
	            	<i class="sidebar-nav-icon icon icon-clipboard"></i>
	                <span class="sidebar-nav-label">원무</span>
	            </a>
	
				 <a href="${pageContext.request.contextPath }/radiologist/workview" class="gnb-item sidebar-nav-item" id="gnb-radiologist">
	            	<i class="sidebar-nav-icon icon icon-doctor-bag"></i>
	                <span class="sidebar-nav-label">영상 검사</span>
	            </a>
	            
	             <a href="${pageContext.request.contextPath }/pharmacist/workview" class="gnb-item sidebar-nav-item" id="gnb-pharmacist">
	            	<i class="sidebar-nav-icon icon icon-drug"></i>
	                <span class="sidebar-nav-label">입원 조제</span>
	            </a>
	            
	            <a href="${pageContext.request.contextPath }/therapist/workview" class="gnb-item sidebar-nav-item" id="gnb-therapist">
	            	<i class="sidebar-nav-icon icon icon-doctor-bag"></i>
	                <span class="sidebar-nav-label">물리치료</span>
	            </a>
