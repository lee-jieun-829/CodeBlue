    ...
    <aside class="sidebar sidebar-vertical">
	    <nav class="gnb sidebar-nav">
	        ...
	        <div class="sidebar-nav-group">
	         <!--    <a href="#" class="gnb-item sidebar-nav-item" id="gnb-dashboard">
	                <i class="sidebar-nav-icon icon icon-desktop"></i>
	                <span class="sidebar-nav-label">대시보드</span>
	            </a> -->
	            
	            <a href="${pageContext.request.contextPath }/nurse/outpatientnurse" class="gnb-item sidebar-nav-item" id="gnb-outpatientnurse">
	            	<i class="sidebar-nav-icon icon icon-doctor-bag"></i>
	                <span class="sidebar-nav-label">외래 간호</span>
	            </a>
	
	            <a href="${pageContext.request.contextPath }/nurse/inpatientnurse" class="gnb-item sidebar-nav-item" id="gnb-inpatientnurse">
	            	<i class="sidebar-nav-icon icon icon-bed"></i>
	                <span class="sidebar-nav-label">입원 간호</span>
	            </a>
	            ...
	            <a href="#" class="gnb-item sidebar-nav-item" id="">
