...
import InsertNewDrug from '../../features/order/InsertNewDrug.jsx';
...
const DrugPage = () => {
  ...
  const [isInsertModalOpen,setIsInsertModalOpen]=useState(false); //새로운 약품 추가
  ...
  return (
    <div className="app h-screen w-full flex flex-col bg-neutral-100 text-zinc-950">
      ...
      <div className="main-container flex flex-1 overflow-hidden">
        ...
        {/* [수정] 캘린더 페이지와 똑같이 aside 태그로 감싸서 스타일(side-bar 등) 적용 */}
        ...
        {/* 3. 오른쪽 콘텐츠 영역 (pl-0으로 사이드바와 밀착) */}
        <main className="main-content flex-1 overflow-hidden pl-4 ml-0">
          <div className="grid grid-cols-[200px_1fr] gap-4 h-full">
            
            {/* 3-1. 재고 관리 메뉴 (내부 사이드바) */}
            <div className="content-area flex flex-col h-full bg-white rounded-r-lg shadow-sm border-y border-r border-gray-200 p-4">
              <div className="mb-4">
